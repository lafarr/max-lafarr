  ...
  return (
    <div>
      <div className="mb-6 flex justify-end">
        <button
          type="button"
          onPointerDown={(e) => { actedInPointerDown.current = false; if (e.pointerType !== 'touch') { setAscending((v) => !v); actedInPointerDown.current = true; } }}
          onClick={() => { if (!actedInPointerDown.current) { setAscending((v) => !v); } actedInPointerDown.current = false; }}
